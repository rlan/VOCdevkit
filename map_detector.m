...
addpath('/Users/rick.lan/data/VOC/VOCdevkit/VOCcode');

% initialize VOC options
VOCinit;
fprintf('Number of classes: %i\n', VOCopts.nclasses);
...
sprintf(VOCopts.imgsetpath,'train')
...
for i=1:length(ids)
    ...
    % read annotation
    ff_anno = sprintf(VOCopts.annopath,ids{i});
    fprintf('Reading %s\n', ff_anno);
    rec=PASreadrecord(ff_anno);
